...
describe('AuthController - Controlador de autenticación', () => {
  ...
  describe('updateProfile', () => {
    it('✅ debería actualizar perfil', async () => {
      ...
      MockAuthService.updateUserProfile.mockResolvedValue({ id: 1, nombre: 'NuevoNombre' } as any);
  ...
  describe('convertToCiudadano', () => {
    it('✅ debería convertir invitado a ciudadano', async () => {
      req.user = { firebase_uid: 'uid-123' };
      req.body = { password: 'new-password' };
      MockAuthService.convertGuestToCitizen.mockResolvedValue({ id: 1, rol: UserRole.USUARIO } as any);
  ...
  describe('changeStatus', () => {
    it('✅ debería cambiar estado de usuario', async () => {
      ...
      MockAuthService.updateUserStatus.mockResolvedValue({ id: 1, estado: 'bloqueado' } as any);
